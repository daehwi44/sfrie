<nav x-data="{ open: false }" class="bg-black border-b border-black">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        {{-- 友達申請一覧 --}}
                        <x-dropdown-link :href="route('friend-requests.index', auth()->user()->id)">
                            Sfrie承認申請一覧
                        </x-dropdown-link>
                        <!-- Authentication -->
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('boshujoho.index')" :active="request()->routeIs('boshujoho.index')">
                学習仲間の募集掲示板
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 font-sans antialiased">
            <div class="px-4">
