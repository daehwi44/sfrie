    ...
    <div class="flex flex-col w-1/4 py-8 bg-white border-r dark:bg-gray-900 dark:border-gray-700">
      ...
      <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
          ...
          <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700">
            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
