<x-app-layout>
  ...
  <div class='flex flex-wrap'>
    ...
    {{-- サイドバー --}}
    <div class="flex flex-col w-80 py-8 bg-white border-r dark:bg-gray-900 dark:border-gray-700">
      ...
      <div class="flex flex-col items-center mt-6 -mx-2">
        ...
        @endif
        <h4 class="mx-2 mt-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">代表者:John Doe</h4>
